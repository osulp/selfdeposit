...
$config['easydeposit_steps'] = array('nologin', 'depositcredentials', 'metadata', 'uploadfiles', 'verify', 'deposit', 'email', 'thankyou', 'ldaplogin', 'uploadfiles');

// Email address for support enquiries for users of the client
$config['easydeposit_supportemail'] = 'hui.zhang@oregonstate.edu';
...
$config['easydeposit_servicedocumentlogin_url'] = 'http://dspace-vm.library.oregonstate.edu:8080/sword/servicedocument';
...
$config['easydeposit_retrieveservicedocument_url'] = "http://dspace-vm.library.oregonstate.edu:8080/sword/servicedocument";
$config['easydeposit_retrieveservicedocument_username'] = "zhanghu";
$config['easydeposit_retrieveservicedocument_password'] = "B00lfhxz";
...
$config['easydeposit_depositcredentials_depositurl'] = 'http://dspace-vm.library.oregonstate.edu:8080/sword/deposit/1957/38282';
$config['easydeposit_depositcredentials_username'] = 'zhanghu';
$config['easydeposit_depositcredentials_password'] = 'B00lfhxz';
...
// Email settings
$config['easydeposit_email_from'] = 'hui.zhang@oregonstate.edu';
