...
class CrossRefDOILookup extends EasyDeposit
{
	...
	if (empty($doi)) 
	{
        ...
        $_SESSION['crossrefdoi-year'] = '';
        $_SESSION['crossrefdoi-journaltitle'] = '';
        $pages = '-';
        $_SESSION['crossrefdoi-volume'] = '';
        $_SESSION['crossrefdoi-issue'] = '';
	...
	//otherwise authorcount will be one more
        $_SESSION['crossrefdoi-authorcount'] = $authorcount-1;
